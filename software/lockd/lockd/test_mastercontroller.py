...
class MasterControllerTest(unittest.TestCase):
    def setUp(self):
        ...
        self.master = mastercontroller.MasterController(
            self.interface, self.input_queue, self.buttons, self.leds
        )
        self.t0 = time.time()
    ...
    def test_leds(self):
        ...
        self.interface.writeMessage.assert_called_with(
            self.master.priority, b"0", p.toMessage(), self.master.tx_msg_queue
        )
    ...
    def test_tick(self, time_mock):
        ...
        time_mock.return_value = self.t0 + 0.6
        self.master.tick()
        self.interface.writeMessage.assert_called_once_with(
            self.master.priority, b"0", query.toMessage(), self.master.tx_msg_queue
        )
        time_mock.return_value = self.t0 + 0.9
        self.master.tick()
        self.interface.writeMessage.assert_called_once_with(
            self.master.priority, b"0", query.toMessage(), self.master.tx_msg_queue
        )
